package com.commercedemo.nop.loadproperty;
...
public class LoadProperty {
    ...
    public String getProperty(String key) {
        ...
        try {
            input = new FileInputStream(projectPath + "/src/test/java/com/commercedemo/nop/resources/properties/config.properties");
